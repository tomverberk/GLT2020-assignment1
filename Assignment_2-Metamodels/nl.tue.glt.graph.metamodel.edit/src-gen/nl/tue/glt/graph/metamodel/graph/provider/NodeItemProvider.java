/**
 */
package nl.tue.glt.graph.metamodel.graph.provider;

import java.util.Collection;
import java.util.List;

import nl.tue.glt.graph.metamodel.graph.GraphFactory;
...
/**
 * This is the item provider adapter for a {@link nl.tue.glt.graph.metamodel.graph.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GraphPackage.Literals.NODE__LABEL, true, false, false,
	...
	protected void addShapePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_shape_feature"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphPackage.Literals.NODE__OUT_EDGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(GraphPackage.Literals.NODE__OUT_EDGES, GraphFactory.eINSTANCE.createEdge()));
	}
